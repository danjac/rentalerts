...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding unique constraint on 'Alert', fields ['apartment', 'user']
        db.create_unique('alerts_alert', ['apartment_id', 'user_id'])


    def backwards(self, orm):
        
        # Removing unique constraint on 'Alert', fields ['apartment', 'user']
        db.delete_unique('alerts_alert', ['apartment_id', 'user_id'])
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 19, 2, 4, 554785, tzinfo=utc)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 19, 2, 4, 554607, tzinfo=utc)'}),
