...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Search.pets'
        db.add_column('alerts_search', 'pets', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Search.smoking'
        db.add_column('alerts_search', 'smoking', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Search.pets'
        db.delete_column('alerts_search', 'pets')

        # Deleting field 'Search.smoking'
        db.delete_column('alerts_search', 'smoking')


    models = {
        'alerts.alert': {
            'Meta': {'ordering': "('-created_on',)", 'unique_together': "(('user', 'apartment'),)", 'object_name': 'Alert'},
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 12, 11, 86618, tzinfo=utc)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 12, 11, 86439, tzinfo=utc)'}),
