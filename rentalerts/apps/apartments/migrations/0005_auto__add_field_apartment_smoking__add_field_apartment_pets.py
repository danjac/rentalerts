...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Apartment.smoking'
        db.add_column('apartments_apartment', 'smoking', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'Apartment.pets'
        db.add_column('apartments_apartment', 'pets', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartment.smoking'
        db.delete_column('apartments_apartment', 'smoking')

        # Deleting field 'Apartment.pets'
        db.delete_column('apartments_apartment', 'pets')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 12, 18, 807434, tzinfo=utc)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 29, 18, 12, 18, 807230, tzinfo=utc)'}),
