...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Apartment.is_available'
        db.add_column('apartments_apartment', 'is_available', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'Apartment.deposit'
        db.add_column('apartments_apartment', 'deposit', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=8, decimal_places=2, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartment.is_available'
        db.delete_column('apartments_apartment', 'is_available')

        # Deleting field 'Apartment.deposit'
        db.delete_column('apartments_apartment', 'deposit')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 21, 9, 15, 55, 264881, tzinfo=utc)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 21, 9, 15, 55, 264691, tzinfo=utc)'}),
