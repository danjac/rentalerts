...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('apartments_apartment', 'num_rooms', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Apartment.num_rooms'
        db.delete_column('apartments_apartment', 'num_rooms')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 19, 21, 20, 57, 306221, tzinfo=utc)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 19, 21, 20, 57, 306045, tzinfo=utc)'}),
