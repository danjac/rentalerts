...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('pm', ['Message'])


    def backwards(self, orm):
        
        # Deleting model 'Message'
        db.delete_table('pm_message')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 19, 42, 40, 464919, tzinfo=utc)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 2, 22, 19, 42, 40, 464690, tzinfo=utc)'}),
